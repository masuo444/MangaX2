...
const DEFAULT_DB = {
  series: [
    { 
      ...
      title: "KUKU ―黎明の木神―",
      author: "Author Name",
      coverUrl: "https://placehold.co/400x600/1a1a1a/FFF?text=KUKU",
      heroUrl: "https://placehold.co/1200x600/1a1a1a/FFF?text=KUKU+HERO",
      description: "世界樹が枯れ果てた世界で、一人の少年が「神」となるまでの物語。圧倒的画力で描くダークファンタジー巨編。",
      totalLikes: 12400,
      isNew: true,
      status: "approved",
      direction: "rtl",
